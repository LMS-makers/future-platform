...
export default function ResetPassword() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-700/10 to-primary-400/20 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-md px-4 sm:px-6 flex flex-col items-center">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="bg-white/95 rounded-xl p-5 mt-6 border border-white/50 shadow-sm">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-bold text-gray-800 mb-2">Password equirements:</h3>
        ...
        <div className="mt-8 text-center">
          <a className="inline-flex items-center text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors" href="#">
