				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						...
						<p className="text-neutral-500 leading-relaxed mb-8">
							Our modern Learning Management System puts everything you need at
							your fingertips. Access course materials, submit assignments,
							track your progress, and collaborate with classmates — all from
						...
						<div className="space-y-4 mb-8">
							{[
								{
									icon: BookOpen,
									text: "Access all course materials and lectures",
								},
